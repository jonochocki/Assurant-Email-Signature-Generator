...
<table style="width:600px; font-size:12px; font-family:'Open Sans',  Helvetica, Arial, sans-serif; margin:0; padding:0;">
	<tr>
		<td style="border-top: 2px solid <?php echo $options['colors']['secondary']; ?>; padding-bottom: 15px; padding-top: 15px;">
	...
	<form id="email-signature-form" action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" target="_blank" autocomplete="off">
		...
		<div class="signature-preview">
			<table style="width:100%;">
				<tr>
					<td style="border-top: 2px solid <?php echo $options['colors']['secondary']; ?>; padding-bottom: 15px;">
		...
		<table width="100%" cellspacing="8" style="padding-top:20px;">
			<tr>
				<td width="65%">
					<p>Click "Create Signature" In the new window, press <strong>CTL + A</strong> (Windows) or <strong>CMD&#8984; + A</strong> (Mac) to select the content. <strong>Copy/paste</strong> this content into your email client settings.
                    <br />
                    <br />
			...
			<tr>
				<td colspan="2">
					...
					<ul class="client-links">
						<li><a href="https://info.assurant.com/l/438242/2022-02-17/92wqyt/438242/1645137322NwGmkKd9/021722_How_to_Update_Your_Email_Signature_TA.docx" target="_blank">How-To Instructions for Outlook</a></li>
					</ul>
				</td>
			</tr>
		</table>
